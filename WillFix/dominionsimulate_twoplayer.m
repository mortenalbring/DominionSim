...
for m=1:maxgames
    ...
    player.two.deck = player.two.deck(randperm(size(player.two.deck,2)));
    ...
    while (table.gameActive == 1)
        ...
        disp(str)
            ...
            [table,player.one] = buySmithy(table,player.one);
        ...
        if (table.gameActive == 1)
            ...
            [table,player.two] = buyBigMoney(table,player.two);
